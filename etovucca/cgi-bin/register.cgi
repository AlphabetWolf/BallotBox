...
render_register() {
    ...
    echo '<h2 id="dlobeid-etovucca-voting-machine">POI Voting Machine</h2><h1 id="voter-registration">Voter Registration</h1><br><form enctype="text/plain"><label for="name">Voter Name</label><br> <input type="text" id="name" name="name"><br> <label for="county">County</label><br> <input type="text" id="county" name="county"><br> <label for="zipc">ZIP Code</label><br> <input type="number" id="zipc" name="zipc"><br> <label for="dob">Date of Birth</label><br> <input type="date" id="dob" name="dob"><br> <input type="submit" value="Submit"></form>'
